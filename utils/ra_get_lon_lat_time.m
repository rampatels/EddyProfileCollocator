function [lon, lat, time] = ra_get_lon_lat_time(float_data, float_ids)%, float_profs)
% ra_get_lon_lat_time  This function is modified from the
% MATLAB toolbox for accessing BGC Argo float data.
%
% USAGE: same as except float_data instead of float_profs
%   [lon, lat, time] = get_lon_lat_time(float_data, float_ids,)
%
% DESCRIPTION:
